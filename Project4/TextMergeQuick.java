...
{
    public static <T extends Comparable<? super T>> void quickSort1(T[] array, int first, int last)
    {
        if (first < last)
        {
            ...
            quickSort1(array, first, pivotIndex - 1);
            quickSort1(array, pivotIndex + 1, last);
        } // end if
    }  // end quickSort

    /** Sorts an array into ascending order. Uses quick sort with
     *  median-of-three pivot selection for arrays of at leastr
     *  MIN_SIZE elements, and uses insertion sort for other arrays. */
    public static <T extends Comparable<? super T>> void quickSort2(T[] a, int first, int last)
    {
        if (last - first + 1 < 5)
        {
    ...
    public static <T extends Comparable<? super T>> void quickSort3(T[] a, int first, int last)
    {
        if (last - first + 1 < 10)
        {
            insertionSort(a, first, last);
        ...
        else
        {
            ...
            // sort subarrays Smaller and Larger
            quickSort3(a, first, pivotIndex - 1);
            quickSort3(a, pivotIndex + 1, last);
        } // end if
    } // end quickSort

    public static <T extends Comparable<? super T>> void quickSort4(T[] a, int first, int last)
    {
        if (last - first + 1 < 20)
        {
            insertionSort(a, first, last);
        ...
        else
        {
            ...
            // sort subarrays Smaller and Larger
            quickSort4(a, first, pivotIndex - 1);
            quickSort4(a, pivotIndex + 1, last);
        } // end if
    } // end quickSort

    public static <T extends Comparable<? super T>> void quickSort5(T[] a, int first, int last)
    {
        if (last - first + 1 < 5)
        {
            insertionSort(a, first, last);
        ...
        else
        {
            ...
            int pivotIndex = random.nextInt((last + 1) - first + 1) + first;
